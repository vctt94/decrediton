const darkTheme = {
  ...
  "menu-settings-active": "url('style/icons/settingsActiveDark.svg')",
  "menu-accounts-default": "url('style/icons/accountsDefaultDark.svg')",
  "menu-accounts-active": "url('style/icons/accountsActiveDark.svg')",
  "menu-governance-default": "url('style/icons/governanceDefaultDark.svg')",
  "menu-governance-active": "url('style/icons/governanceActiveDark.svg')",
  "menu-transactions-default": "url('style/icons/transactionsDefaultDark.svg')",
  "menu-transactions-active": "url('style/icons/transactionsActiveDark.svg')",
  "menu-overview-default": "url('style/icons/overviewDefaultDark.svg')",
  "menu-overview-active": "url('style/icons/overviewActiveDark.svg')",
  "menu-securitycntr-default": "url('style/icons/securityDefaultDark.svg')",
  "menu-securitycntr-active": "url('style/icons/securityActiveDark.svg')",
  "menu-tickets-default": "url('style/icons/ticketsDefaultDark.svg')",
  "menu-tickets-active": "url('style/icons/ticketsActiveDark.svg')",
  "menu-help-default": "url('style/icons/helpActiveDark.svg')",
  "menu-help-active": "url('style/icons/helpDefaultDark.svg')",
  ...
  "header-help": "url('style/icons/helpHeaderDark.svg')",
  ...
  "header-security": "url('style/icons/securityCenterHeaderDark.svg')",
